...
//npx hardhat run --network bsc_mainnet scripts/nft.js
...
//
   ...
   // const egc = await UsToken.deploy("Energy Crystal", "EGC");
    ...
    const busd1 = await BusdToken.deploy("BUSD", "BUSD",_total.toString());
    await busd1.deployed();
    console.log("busd deployed to:", busd1.address);
